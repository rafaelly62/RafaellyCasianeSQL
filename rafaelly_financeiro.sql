...
--
-- Banco de dados: `rafaelly_financeiro`
--
CREATE DATABASE IF NOT EXISTS `rafaelly_financeiro` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `rafaelly_financeiro`;
...
(1, 'Rafaelly Cassiane Pedro da Silva', '023.456.789-10'),
